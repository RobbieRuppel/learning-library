...
1. Enter your first table and some columns.
    ...
    ![](images/2/enter-team-members.png)
...
1. Click **Help**   
    ...
    ![](images/2/table-directives.png)

2. Click **Column Directives**

    ![](images/2/column-directives.png)

3. Click **Data Types**

    ![](images/2/data-types.png)
...
1. In the SQL (right pane) toolbar, click **Settings**
    ...
    ![](images/2/settings.png)
    ![](images/2/settings2.png)
